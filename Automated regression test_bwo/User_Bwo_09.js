...
/// Then il devient client de Birds worker
           ...
           cy.get('.email').type('marseille00078@gmail.com').should('have.value','marseille00078@gmail.com');/// check password value is displayed
...
/// Then un message lui indique <Veuillez renseigner une adresse e-mail valide>
           ...
           cy.wait(500);
           cy.get('input').invoke('attr', 'placeholder').should('contain', 'moi@adresse.com');/// placeholder name verification
           cy.get('.email').type('marseille00078gmail.com').should('have.value','marseille00078@npx cypress gmail.com');/// check password value is displayed
